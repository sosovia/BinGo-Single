...
import com.bingo.common.core.enums.DateTimeFormat;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static String getDate() {
        return dateTimeNow(DateTimeFormat.YYYY_MM_DD);
    }
    ...
    public static String getCurrentDate() {
        return DateFormatUtils.format(new Date(), DateTimeFormat.YYYYMMDD.getTimeFormat());
    }
    ...
    public static String datePath() {
        Date now = new Date();
        return DateFormatUtils.format(now, DateTimeFormat.YYYY_MM_DD_SLASH.getTimeFormat());
    }
    ...
    public static String getTime() {
        return dateTimeNow(DateTimeFormat.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String getTimeWithHourMinuteSecond() {
        return dateTimeNow(DateTimeFormat.HH_MM_SS);
    }
    ...
    public static String dateTimeNow() {
        return dateTimeNow(DateTimeFormat.YYYYMMDDHHMMSS);
    }
    ...
    public static String formatDate(final Date date) {
        return parseDateToStr(DateTimeFormat.YYYY_MM_DD, date);
    }
    ...
    public static String formatDateTime(final Date date) {
        return parseDateToStr(DateTimeFormat.YYYY_MM_DD_HH_MM_SS, date);
    }
    ...
    public static String formatFriendlyTime(Date date) {
        ...
        if (date.after(now) || DateUtil.year(date) != DateUtil.year(now)) {
            return parseDateToStr(DateTimeFormat.YYYY_MM_DD_HH_MM, date);
        }
