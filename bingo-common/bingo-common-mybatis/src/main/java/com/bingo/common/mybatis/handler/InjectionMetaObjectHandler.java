package com.bingo.common.mybatis.handler;
...
import com.bingo.common.core.service.LoginUserProvider;
...
//                Long userId = LoginHelper.getUserId();
                Long userId = Objects.requireNonNull(getLoginUser()).getUserId();
...
//            loginUser = LoginHelper.getLoginUser();
            loginUser = loginUserProvider.getLoginUser();
        } catch (Exception e) {
            return null;
        }
        return loginUser;
