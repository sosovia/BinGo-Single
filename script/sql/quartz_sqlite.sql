...
create table QRTZ_TRIGGERS (
                               ...
                               description          varchar(250)    null                , -- '相关介绍',
                               next_fire_time       bigint(13)      null                , -- '上一次触发时间（毫秒）',
                               prev_fire_time       bigint(13)      null                , -- '下一次触发时间（默认为-1表示不触发）',
                               ...
                               misfire_instr        smallint(2)     null                , -- '补偿执行的策略',
                               job_data             blob            null                , -- '存放持久化job对象',
...
create table QRTZ_SIMPLE_TRIGGERS (
                                      ...
                                      repeat_count         bigint(7)       not null            , -- '重复的次数统计',
                                      repeat_interval      bigint(12)      not null            , -- '重复的间隔时间',
                                      times_triggered      bigint(10)      not null            , -- '已经触发的次数',
                                      primary key (sched_name, trigger_name, trigger_group),
...
create table QRTZ_FIRED_TRIGGERS (
                                     ...
                                     fired_time           bigint(13)      not null            , -- '触发的时间',
                                     sched_time           bigint(13)      not null            , -- '定时器制定的时间',
