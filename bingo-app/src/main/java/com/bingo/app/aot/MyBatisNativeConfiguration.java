...
//                    MybatisSqlSessionFactoryBean.class,
            ...
            hints.reflection().registerType(BoundSql.class, MemberCategory.ACCESS_PUBLIC_FIELDS);
            hints.reflection().registerType(RoutingStatementHandler.class, MemberCategory.ACCESS_PUBLIC_FIELDS);
            hints.reflection().registerType(BaseStatementHandler.class, MemberCategory.ACCESS_PUBLIC_FIELDS);
            ...
            hints.reflection().registerType(MybatisParameterHandler.class, MemberCategory.ACCESS_PUBLIC_FIELDS);
